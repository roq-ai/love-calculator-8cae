  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the magic of love with Love Calculator App! Enter names, hit calculate, and let the love meter reveal your compatibility. Share your results, reset, and play again. A romantic, responsive design for love seekers on any device."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1527628173875-3c7bfd28ad78?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsb3ZlfGVufDB8fHx8MTY5NTI4NTgxMHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the magic of love with Love Calculator App! Enter names, hit calculate, and let the love meter reveal your compatibility. Share your results, reset, and play again. A romantic, responsive design for love seekers on any device.`}
            </Text>
            <Box
