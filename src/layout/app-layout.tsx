...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Resets', path: '/resets', entity: 'reset', service: AccessServiceEnum.PROJECT, icon: FiRotateCcw },
    { name: 'Shares', path: '/shares', entity: 'share', service: AccessServiceEnum.PROJECT, icon: FiShare },
    {
      name: 'Shared Results',
      path: '/shared-results',
